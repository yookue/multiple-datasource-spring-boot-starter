...
public class PrimaryDataSourceJdbcConfiguration {
    ...
    static class Xa {
        ...
        public DataSource dataSource(@Nonnull DataSourceBuilder builder, @Nonnull XADataSourceWrapper wrapper, @Qualifier(value = DATA_SOURCE_PROPERTIES) @Nonnull DataSourceProperties properties) throws Exception {
            return builder.xaDataSource(wrapper, properties);
        }
    }
    ...
    static class Druid {
        ...
        @ConditionalOnMissingBean(name = DATA_SOURCE)
        public com.alibaba.druid.pool.DruidDataSource dataSource(@Nonnull DataSourceBuilder builder, @Qualifier(value = DATA_SOURCE_PROPERTIES) @Nonnull DataSourceProperties properties, @Nullable List<com.alibaba.druid.filter.Filter> filters) {
