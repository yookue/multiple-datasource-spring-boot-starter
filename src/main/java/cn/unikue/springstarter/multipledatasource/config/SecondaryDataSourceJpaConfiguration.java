...
@ConditionalOnAllBooleanProperties(value = {
    ...
    @ConditionalOnBooleanProperty(prefix = SecondaryDataSourceJdbcConfiguration.PROPERTIES_PREFIX, name = "jpa-enabled", matchIfMissing = true)
})
...
public class SecondaryDataSourceJpaConfiguration {
    ...
    @ConditionalOnBooleanProperty(prefix = SecondaryDataSourceJpaConfiguration.PROPERTIES_PREFIX, name = "jpa-transaction", matchIfMissing = true)
